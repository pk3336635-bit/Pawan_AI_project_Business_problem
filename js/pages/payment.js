...
function buildOrder(method) {
  ...
  return {
    ...
    address: checkout.deliveryType === 'pickup' ? 'Store pickup — Aghoria Bazaar Branch' : checkout.address,
    landmark: checkout.landmark || null,
    area: checkout.landmark || checkout.address?.slice(0, 40) || 'Muzaffarpur',
